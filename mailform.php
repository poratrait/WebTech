...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    try {
        ...
        $mail->Username   = 'sampadaghale71@gmail.com';             // Your Gmail address
        $mail->Password   = 'lktj yvxe afug anzx';               // Use app password
        $mail->SMTPSecure = PHPMailer::ENCRYPTION_SMTPS;           // Enable implicit TLS encryption
        $mail->Port       = 465;                                    // TCP port

        // Recipients
        $mail->setFrom($email, $name);
        $mail->addAddress('ghalesampada7@gmail.com', 'Receiver');
